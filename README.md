# U_DSND_Recommendations_with_IBM
Recommendation skills to use on real data from the IBM Watson Studio platform

### Introduction
 In this project we'll analyze the interactions that users have with articles on the IBM Watson Studio platform, 
 and make recommendations to them about new articles they'll like.
